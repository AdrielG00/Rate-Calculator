...
function getAdditionalFunds() {
  ...
  if (arsTotal - quote < 150) {
    ...
    addTotal = `No Additional Funds needed - Proceed with dispatch.  Make sure to verbally state your disclaimer and send it along with the email.<br>*Confirm all in cost, equipment and all logistics and properly notate the move. <br><br> We are dispatching this unit for tow for $${quote} all in with an ETA of ${eta} minutes as discussed. If anything is other than described, additional services requested or any changes that would affect cost, please make sure to call 877-390-7673 for prior approval. Please keep us updated should your ETA change for whatever reason so that we may keep our customer informed. Thank you!<br><br>**Make sure the vendor received the paperwork!<br>**Make sure to update the customer/client email chain on ETA!<br>**Make sure to note any important details in the move!`;
...
function getOOPFunds() {
  ...
  if (500 - quote < 125) {
    ...
    oopCost = `No OOP Costs - Proceed with dispatch.  Make sure to verbally state your disclaimer and send it along with the email.<br>*Confirm all in cost, equipment and all logistics and properly notate the move.  <br><br> We are dispatching this unit for tow for $${quote} all in with an ETA of ${eta} minutes as discussed. If anything is other than described, additional services requested or any changes that would affect cost, please make sure to call 877-390-7673 for prior approval. Please keep us updated should your ETA change for whatever reason so that we may keep our customer informed. Thank you!<br><br>**Make sure the vendor received the paperwork!<br>**Make sure to update the customer/client on ETA!<br>**Make sure to note any important details in the move!`;
  }
  document.getElementById("oop-cost").innerHTML = oopCost;
  document.getElementById("add-cost").innerHTML = addTotal;
  document.getElementById("add-cost").style.color = "black";
...
function overages() {
  ...
  switch (client) {
    ...
    case "other":
      ...
      document.getElementById("add-cost").innerHTML = addTotal;
      document.getElementById("add-cost").style.color = "black";
      dispatchDisclaimer = `If you are over TPG - Make sure you get quote approval from a Team Lead or Management.  If not, Make sure to verbally state your disclaimer and send it along with the email.<br>*Confirm all in cost, equipment and all logistics and properly notate the move. <br><br> We are dispatching this unit for tow for $${quote} all in with an ETA of ${eta} minutes as discussed. If anything is other than described, additional services requested or any changes that would affect cost, please make sure to call 877-390-7673 for prior approval. Please keep us updated should your ETA change for whatever reason so that we may keep our customer informed. Thank you!<br><br>**Make sure the vendor received the paperwork!<br>**Make sure to update the customer/client on ETA!<br>**Make sure to note any important details in the move!`;
      break;
  }
